...
let Home = () => {
    return (
        ...
        <div className="home-content">
            <h1>Welcome to The Culinary Haven</h1>
            <image src='https://images.pexels.com/photos/1640777/pexels-photo-1640777.jpeg'/>
            <h2>Discover the Art of Fine Dining</h2>
            <p>Welcome to The Culinary Haven, where culinary excellence meets a warm and inviting atmosphere. Located in the heart of downtown, our restaurant is the perfect destination for food enthusiasts seeking an unforgettable dining experience.</p>
        </div>
